...
// ❌ Removed invalid import: Textarea from "../ui/input"
    ...
    return (
      <div className="min-h-screen bg-white">
        <div className="bg-[#0A2540] text-white px-4 py-4 flex items-center gap-3">
          ...
          <h2 className="text-white flex-1 text-lg font-semibold">
            List Your Spot
          </h2>
        </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="number"
                      placeholder="15"
                      className="pl-7 text-[#0A2540] bg-white"
                    />
                  </div>
                </div>
                <div>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Allow pre-game gatherings
                    </p>
                  </div>
                </div>
                <Switch
                  checked={tailgateFriendly}
                  onCheckedChange={setTailgateFriendly}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Allow parking after event
                    </p>
                  </div>
                </div>
                <Switch
                  checked={overnightParking}
                  onCheckedChange={setOvernightParking}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={bathroomAccess}
                  onCheckedChange={setBathroomAccess}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={setShuttleService}
                />
              </div>
            </CardContent>
          </Card>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <Plus className="w-4 h-4 mr-2" /> Add Spot
            </Button>
          </div>
              ...
              <Card key={s.id} className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  <div className="flex items-start gap-4">
                    <div className="bg-gradient-to-br from-[#0A2540] to-[#134E6F] rounded-lg p-3 flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm mb-2">
                        <div>
                          ...
                          <p className="text-[#0A2540]">{s.totalBookings}</p>
                        </div>
                        <div>
                          <p className="text-gray-600">Earnings</p>
                          <p className="text-[#0A2540]">${s.earnings}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        <Calendar className="w-3 h-3" />
                        <span>Next: {s.nextEvent}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
